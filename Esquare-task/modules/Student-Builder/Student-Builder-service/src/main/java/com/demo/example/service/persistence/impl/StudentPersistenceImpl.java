...
package com.demo.example.service.persistence.impl;

import com.demo.example.exception.NoSuchStudentException;
import com.demo.example.model.Student;
import com.demo.example.model.StudentTable;
import com.demo.example.model.impl.StudentImpl;
import com.demo.example.model.impl.StudentModelImpl;
import com.demo.example.service.persistence.StudentPersistence;
import com.demo.example.service.persistence.StudentUtil;
import com.demo.example.service.persistence.impl.constants.HEADLESSPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	@Override
	@Reference(
		target = HEADLESSPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = HEADLESSPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
