...
package com.demo.example.service.persistence;
...
public class StudentUtil {
	...
	public static Student remove(long id)
		throws com.demo.example.exception.NoSuchStudentException {
